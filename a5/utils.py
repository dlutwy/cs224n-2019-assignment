...
def pad_sents_char(sents, char_pad_token):
    ...
    pad_word = lambda word: word[:max_word_length] + (max_word_length- len(word)) * [char_pad_token]
    sents_padded = [[ pad_word(word) for word in sent] for sent in sents]
    sents_padded = [ sent + (max_sent_len - len(sent)) *[max_word_length * [char_pad_token]] for sent in sents_padded]
    ### END YOUR CODE
